    ...
    return (
        <main className="px-[5%] py-10 bg-[#f0f3f2] text-[#5C6C75]">
            <section className="flex items-start justify-between flex-wrap gap-4 text-sm">
                ...
                <div className="flex flex-col gap-3">
                    <h3 className="font-medium text-[#000000]">Freshcart programs</h3>
                    <div className="flex flex-col gap-2">
                        <a href="#" className="hover:text-[#0AAD0A]">Freshcart programs</a>
                        <a href="#" className="hover:text-[#0AAD0A]">Gift Cards</a>
                        <a href="#" className="hover:text-[#0AAD0A]">Promos & Coupons</a>
                        <a href="#" className="hover:text-[#0AAD0A]">Freshcart Ads</a>
            ...
            <section className="flex flex-col lg:flex-row items-center justify-between gap-4 py-4 mt-5 border-t-2 border-b-2">
                ...
                <div className="flex flex-col md:flex-row items-center justify-center gap-2">
                    <p className="font-medium text-[#000000]">Get deliveries with FreshCart</p>
            ...
            <section className="flex flex-col lg:flex-row items-center justify-between gap-4 py-4 mt-5 text-sm">
                <div>
                    <p className="text-center lg:text-left">© 2022 - 2024 FreshCart eCommerce HTML Template. All rights reserved. Developed by <br /> <a href="https://iamnaeto.vercel.app" className="text-[#0AAD0A]">Charles Obimnaeto Egesionu</a></p>
                </div>
